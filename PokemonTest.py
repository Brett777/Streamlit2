...
def getPrice(cardName,cardNumber):
    ...
    st.write("Alltime Average $" +str(round(int(myCard[0].cardmarket.prices.avg30)*1.4502,2)))
    st.write(str(myCard[0].rarity))

st.button(label="Get Price", on_click=getPrice(cardName,cardNumber))